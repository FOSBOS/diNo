namespace diNo
{
    partial class UserControlFPAundSeminar
    {
      ...
      this.textBoxSeminarfachthemaKurz.TabIndex = 9;
      // 
      ...
      this.textBoxSeminarfachthemaLang.TabIndex = 10;
      // 
      // label5
      // 
      ...
      this.numSeminarpunkte.TabIndex = 8;
      this.numSeminarpunkte.Value = new decimal(new int[] {
            0,
            0,
            0,
            0});
      ...
      this.numPunkte1Hj.Value = new decimal(new int[] {
            0,
            0,
            0,
            0});
      ...
      this.numPunkte2Hj.Value = new decimal(new int[] {
            0,
            0,
            0,
            0});
      ...
      this.numPunkte.Value = new decimal(new int[] {
            0,
            0,
            0,
            0});
